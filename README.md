# Fragrance / beauty brand template — live WebGL aurora

**Live demo → https://bswxyz.github.io/fable-aurelis/** · [How it was built](https://bswxyz.github.io/fable-aurelis/guide/)
...
```bash
gh repo create my-site --template bswxyz/fable-aurelis --public --clone
cd my-site
